...
//=================================================================================================
void NetImguiServer::RenderDelegateDX11::RenderDrawData(RemoteClient::Client& client, ImDrawData* pDrawData) const
{
...
//=================================================================================================
bool NetImguiServer::RenderDelegateDX11::CreateTexture(uint16_t Width, uint16_t Height, NetImgui::eTexFormat Format, const uint8_t* pPixelData, App::ServerTexture& OutTexture) const
{
...
//=================================================================================================
void NetImguiServer::RenderDelegateDX11::DestroyTexture(App::ServerTexture& OutTexture) const
{
...
//=================================================================================================
bool NetImguiServer::RenderDelegateDX11::CreateRenderTarget(uint16_t Width, uint16_t Height, void*& pOutRT, void*& pOutTexture) const
{
...
//=================================================================================================
void NetImguiServer::RenderDelegateDX11::DestroyRenderTarget(void*& pOutRT, void*& pOutTexture) const
{
	if (pOutRT)
	{
