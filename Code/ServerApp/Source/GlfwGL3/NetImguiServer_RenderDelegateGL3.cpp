...
//=================================================================================================
void NetImguiServer::RenderDelegateGL3::RenderDrawData(RemoteClient::Client& client, ImDrawData* pDrawData) const
{
...
//=================================================================================================
bool NetImguiServer::RenderDelegateGL3::CreateTexture(uint16_t Width, uint16_t Height, NetImgui::eTexFormat Format, const uint8_t* pPixelData, App::ServerTexture& OutTexture) const
{
...
//=================================================================================================
void NetImguiServer::RenderDelegateGL3::DestroyTexture(App::ServerTexture& OutTexture) const
{
...
//=================================================================================================
bool NetImguiServer::RenderDelegateGL3::CreateRenderTarget(uint16_t Width, uint16_t Height, void*& pOutRT, void*& pOutTexture) const
{
	DestroyRenderTarget(pOutRT, pOutTexture);
...
//=================================================================================================
void NetImguiServer::RenderDelegateGL3::DestroyRenderTarget(void*& pOutRT, void*& pOutTexture) const
{
	if (pOutRT)
	{
...
bool NetImguiServer::RenderDelegateGL3::IsRenderTargetInverted() const
{
	return true;
}
