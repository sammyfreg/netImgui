...
{	
	...
	public class NetImguiTarget : ITarget
	{
		...
		{		
			...
			targets.Add(new NetImguiTarget{DevEnv = DevEnv.xcode4ios, Compiler = Compiler.Clang});
    ...
    public class ProjectBase : Project
	{
        ...
        {			
			...
			conf.Options.Add(new Sharpmake.Options.XCode.Compiler.SystemFrameworks("IOKit"));
			conf.Options.Add(new Sharpmake.Options.XCode.Compiler.SystemFrameworks("CoreFoundation"));
			conf.Options.Add(new Sharpmake.Options.XCode.Compiler.SystemFrameworks("CoreGraphics"));
			conf.Options.Add(new Sharpmake.Options.XCode.Compiler.MacOSDeploymentTarget("13.0"));
			conf.Options.Add(Sharpmake.Options.XCode.Compiler.Exceptions.Enable);
		}
		
		// Add sources files for platform specific Dear ImGui backend (OS/Renderer support)
		public void AddImguiBackendSources()
		{
			SourceFiles.Add(NetImguiTarget.GetPath(ProjectImgui.sDefaultPath) + @"\backends\imgui_impl_glfw.h");
			SourceFiles.Add(NetImguiTarget.GetPath(ProjectImgui.sDefaultPath) + @"\backends\imgui_impl_glfw.cpp");
			SourceFiles.Add(NetImguiTarget.GetPath(ProjectImgui.sDefaultPath) + @"\backends\imgui_impl_opengl3.h");
			SourceFiles.Add(NetImguiTarget.GetPath(ProjectImgui.sDefaultPath) + @"\backends\imgui_impl_opengl3.cpp");
		}
